...
<body class="min-h-screen bg-white text-zinc-950 flex flex-col justify-between">
 ...
 <a href="{{ route('social.redirect', ['provider' => 'google', 'action' => 'register']) }}"  class="w-full py-3 px-4 border border-zinc-200 hover:bg-zinc-50 rounded-[0.45rem] text-sm font-semibold flex items-center justify-center space-x-2.5 transition-all text-zinc-700">
 <!-- Google G SVG Logo -->
 ...
 <a href="{{ route('social.redirect', ['provider' => 'facebook', 'action' => 'register']) }}"  class="w-full py-3 px-4 bg-[#1877f2] hover:bg-[#166fe5] text-white rounded-[0.45rem] text-sm font-semibold flex items-center justify-center space-x-2.5 transition-all">
 <!-- Facebook SVG Logo -->
 ...
 <a href="{{ route('social.redirect', ['provider' => 'apple', 'action' => 'register']) }}"  class="w-full py-3 px-4 bg-black hover:bg-zinc-900 text-white rounded-[0.45rem] text-sm font-semibold flex items-center justify-center space-x-2.5 transition-all">
 <!-- Apple SVG Logo -->
 <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
 ...
 I agree to the  <a href="/v1/pages/{{ \App\Models\SiteSetting::getVal('terms_page_slug', 'terms-of-service') }}" target="_blank" class="underline hover:text-zinc-800">Terms of Service</a>  and  <a href="/v1/pages/{{ \App\Models\SiteSetting::getVal('privacy_page_slug', 'privacy-policy') }}" target="_blank" class="underline hover:text-zinc-800">Privacy Policy</a>.
 </span>
 </label>
 @error('terms')
 <p class="text-xs text-red-600 font-bold mt-1">{{ $message }}</p>
 ...
 Already have an account?  <a href="{{ route('login') }}" class="text-blue-655 hover:underline">Log in</a>
 </p>
 </div>
