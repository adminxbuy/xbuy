...
<head>
 ...
 <title>Log in | {{ \App\Models\SiteSetting::getVal('platform_name', 'X-Buy') }}</title>
...
<body class="min-h-screen bg-white text-zinc-950 flex flex-col justify-between">
 ...
 <h1 class="text-3xl font-bold text-zinc-900 tracking-tight">Log in to {{ \App\Models\SiteSetting::getVal('platform_name', 'X-Buy') }}</h1>
 </div>
 ...
 @if ($errors->any() && !$errors->has('email') && !$errors->has('password') && !$errors->has('social'))
 ...
 <a href="{{ route('social.redirect', ['provider' => 'google', 'action' => 'login']) }}"  class="w-full py-3 px-4 border border-zinc-200 hover:bg-zinc-50 rounded-[0.45rem] text-sm font-semibold flex items-center justify-center space-x-2.5 transition-all text-zinc-700">
 <!-- Google G SVG Logo -->
 ...
 <a href="{{ route('social.redirect', ['provider' => 'facebook', 'action' => 'login']) }}"  class="w-full py-3 px-4 bg-[#1877f2] hover:bg-[#166fe5] text-white rounded-[0.45rem] text-sm font-semibold flex items-center justify-center space-x-2.5 transition-all">
 <!-- Facebook SVG Logo -->
 ...
 <a href="{{ route('social.redirect', ['provider' => 'apple', 'action' => 'login']) }}"  class="w-full py-3 px-4 bg-black hover:bg-zinc-900 text-white rounded-[0.45rem] text-sm font-semibold flex items-center justify-center space-x-2.5 transition-all">
 <!-- Apple SVG Logo -->
 <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
 ...
 <input :type="show ? 'text' : 'password'" id="password" name="password" required placeholder="Enter your password"
 ...
 <span class="ml-2.5 text-xs font-medium text-zinc-650">Remember me</span>
 </label>
 <a href="{{ route('password.request') }}" class="text-xs font-semibold text-blue-650 hover:underline">Forgot password?</a>
 </div>
 ...
 <p class="text-[10px] leading-relaxed text-zinc-400 max-w-sm">
 This site is protected by reCAPTCHA Enterprise and the Google  <a href="https://policies.google.com/privacy" target="_blank" class="underline hover:text-zinc-600">Privacy Policy</a> and  <a href="https://policies.google.com/terms" target="_blank" class="underline hover:text-zinc-600">Terms of Service</a> apply.
 </p>
 <p class="text-sm font-medium text-zinc-650">
 Don't have an account?  <a href="{{ route('register') }}" class="text-blue-650 hover:underline">Sign up</a>
 </p>
 </div>
