            ...
            <div class="max-w-md w-full space-y-7">
                ...
                <div class="space-y-3">
                    ...
                    @if(\App\Models\SiteSetting::getVal('apple_login_enabled'))
                        <a href="{{ route('social.redirect', ['provider' => 'apple', 'action' => 'login']) }}" 
                ...
                <div class="pt-4 border-t border-zinc-100 flex flex-col items-center space-y-3.5 text-center">
                    <p class="text-[10px] leading-relaxed text-zinc-400 max-w-sm">
                        ...
                        <a href="https://policies.google.com/privacy" target="_blank" class="underline hover:text-zinc-600">Privacy Policy</a> and 
                        <a href="https://policies.google.com/terms" target="_blank" class="underline hover:text-zinc-600">Terms of Service</a> apply.
                    </p>
                    <p class="text-sm font-medium text-zinc-650">
                        Don't have an account? 
                        <a href="{{ route('register') }}" class="text-blue-650 hover:underline">Sign up</a>
                    </p>
                </div>
