...
<div class="bg-zinc-50 min-h-[calc(100vh-120px)] py-10">
 ...
 <div class="bg-white border border-zinc-200 rounded-sm p-8 transition-all duration-300">
 ...
 <input type="tel" id="phone" name="phone" required  placeholder="Enter phone number"  value="{{ old('phone', $user->phone ?? '') }}"
 ...
 <input type="text" id="otp-code" name="otp" required maxlength="6"  placeholder="Enter 6-digit code"  class="w-full text-base text-zinc-800 bg-transparent border-none outline-none focus:ring-0 p-0 font-medium placeholder-zinc-350 tracking-widest text-center md:text-left">
 </div>
