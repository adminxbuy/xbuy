...
<div class="bg-zinc-50 min-h-[calc(100vh-120px)] py-10">
 ...
 <form action="/dashboard/settings/payments/add-card" method="POST" class="space-y-4"  x-data="{  cardNumber: '',
 expiry: '',
 formatCard(e) {
 ...
 <input type="text" id="card_number" name="card_number" required placeholder="4111 2222 3333 4444"  x-model="cardNumber" @input="formatCard" maxlength="23"
 ...
 <input type="text" id="expiry_date" name="expiry_date" required placeholder="MM/YY"  x-model="expiry" @input="formatExpiry" maxlength="5"
 class="w-full border border-zinc-300 rounded-sm px-3 py-2 text-sm focus:border-[#e6c019] focus:ring-1 focus:ring-[#e6c019] outline-none">
 </div>
 <div class="space-y-1">
