                ...
                <form action="/dashboard/settings/email/verify" method="POST" class="space-y-6">
                    ...
                    <div class="border-b border-zinc-200 focus-within:border-zinc-800 pb-2 transition-colors duration-150">
                        <input type="text" name="otp" required maxlength="6" placeholder="e.g. 123456" 
                               class="w-full text-lg text-zinc-800 bg-transparent border-none outline-none focus:ring-0 p-0 font-medium placeholder-zinc-300 tracking-widest text-center md:text-left">
                    </div>
