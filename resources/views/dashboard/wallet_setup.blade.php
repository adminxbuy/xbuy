                        ...
                        <div class="flex flex-col md:flex-row md:items-start justify-between py-4 border-b border-zinc-200">
                            ...
                            <div class="flex-1 space-y-2">
                                <input type="password" id="ssn_last_four" name="ssn_last_four" required maxlength="4"
                                       ...
                                       class="w-full text-[15px] text-zinc-800 bg-transparent border-none outline-none focus:ring-0 p-0 font-medium placeholder-zinc-350">
                        ...
                        <div class="flex flex-col md:flex-row md:items-start justify-between py-4">
                            ...
                            <div class="flex-1 w-full">
                                <textarea id="billing_address" name="billing_address" required rows="2"
                                          placeholder="Enter your billing address details" 
                                          class="w-full text-[15px] text-zinc-800 bg-transparent border-b border-zinc-200 focus:border-[#e6c019] outline-none resize-none placeholder-zinc-350 pb-2 text-left focus:ring-0">{{ old('billing_address', $user->address) }}</textarea>
                            </div>
                        </div>
                    </div>
