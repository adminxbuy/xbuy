                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 py-5">
                                ...
                                <div class="flex-1 w-full">
                                    <input type="text" id="bank_account_name" name="bank_account_name" required 
                                           value="{{ old('bank_account_name', $user->sellerProfile->bank_account_name ?? '') }}" 
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 py-5">
                                ...
                                <div class="flex-1 w-full">
                                    <input type="text" id="bank_account_number" name="bank_account_number" required 
                                           value="{{ old('bank_account_number', $user->sellerProfile->bank_account_number ?? '') }}" 
                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 py-5">
                                ...
                                <div class="flex-1 w-full">
                                    <input type="text" id="bank_ifsc" name="bank_ifsc" required 
                                           value="{{ old('bank_ifsc', $user->sellerProfile->bank_ifsc ?? '') }}" 
                                           placeholder="e.g. SBIN0001234" 
                                           class="w-full text-base text-zinc-800 bg-transparent border-none outline-none focus:ring-0 p-0 font-medium uppercase placeholder-zinc-300">
                                </div>
                            </div>
