            ...
            <div class="flex-1 space-y-6">
                ...
                <div class="bg-zinc-50 border border-zinc-200 rounded-sm p-4 flex gap-3.5 items-start">
                    ...
                    <p class="text-sm text-zinc-650 leading-relaxed">
                        Disabling shipping options may reduce sales. If a member can only buy from you with a disabled option, we may still offer it. 
                        <a href="#" class="text-[#e6c019] hover:underline font-semibold">Learn more about disabled options.</a>
                    </p>
                </div>
                        ...
                        <div class="space-y-2 border border-zinc-200 rounded-sm bg-white overflow-hidden">
                            ...
                            <div x-show="activeAccordion === 'address'" class="border-t border-zinc-150 divide-y divide-zinc-150 bg-zinc-50/50">
                                ...
                                <div class="p-4 pl-14 bg-amber-50/30 space-y-2">
                                    ...
                                    <div class="flex gap-2 max-w-xl">
                                        <input type="text" 
                                               ...
                                               class="flex-1 text-sm text-zinc-700 bg-white border border-zinc-200 rounded-sm px-3 py-1.5 focus:border-[#e6c019] focus:outline-none">
                                        <button type="button" 
                                                @click="savePickupAddress()" 
                                                class="px-4 py-1.5 bg-[#e6c019] text-black text-xs font-bold rounded-sm hover:bg-[#fdd835] transition-colors flex items-center gap-1 shrink-0">
                                ...
                                <div class="flex items-center justify-between p-4 pl-14">
                                    ...
                                    <button type="button" 
                                            @click="toggleOption('ship_bluedart_pickup')" 
                                ...
                                <div class="flex items-center justify-between p-4 pl-14">
                                    ...
                                    <button type="button" 
                                            @click="toggleOption('ship_delhivery_pickup')" 
                                            class="w-12 h-6 rounded-full p-0.5 focus:outline-none cursor-pointer"
                                ...
                                <div class="flex items-center justify-between p-4 pl-14">
                                    ...
                                    <button type="button" 
                                            @click="toggleOption('ship_dtdc_pickup')" 
                                            class="w-12 h-6 rounded-full p-0.5 focus:outline-none cursor-pointer"
                        ...
                        <div class="space-y-2 border border-zinc-200 rounded-sm bg-white overflow-hidden">
                            ...
                            <div x-show="activeAccordion === 'dropoff'" class="border-t border-zinc-150 divide-y divide-zinc-150 bg-zinc-50/50">
                                ...
                                <div class="flex items-center justify-between p-4 pl-14">
                                    ...
                                    <button type="button" 
                                            @click="toggleOption('ship_delhivery_dropoff')" 
                                            class="w-12 h-6 rounded-full p-0.5 focus:outline-none cursor-pointer"
                                ...
                                <div class="flex items-center justify-between p-4 pl-14">
                                    ...
                                    <button type="button" 
                                            @click="toggleOption('ship_bluedart_dropoff')" 
                                            class="w-12 h-6 rounded-full p-0.5 focus:outline-none cursor-pointer"
                                ...
                                <div class="flex items-center justify-between p-4 pl-14">
                                    ...
                                    <button type="button" 
                                            @click="toggleOption('ship_dtdc_dropoff')" 
                                            class="w-12 h-6 rounded-full p-0.5 focus:outline-none cursor-pointer"
