                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-sm text-zinc-500 leading-relaxed max-w-xl">
                                Request and download a copy of your account data. 
                                <a href="#" class="text-[#007f87] hover:underline font-semibold">Learn more about account data</a>
                            </p>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white border border-zinc-200 rounded-sm p-8 space-y-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <p class="text-sm text-zinc-500 leading-relaxed">
                                Want more information on why we collect and use your data, who we share it with, or how long we keep it? 
                                <a href="#" class="text-[#007f87] hover:underline font-semibold">Contact us</a>
                            </p>
                        </div>
                    </div>
