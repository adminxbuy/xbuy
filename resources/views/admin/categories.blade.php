...
@section('content')
 ...
 <a href="{{ route('admin.trash.index', 'categories') }}" class="flex items-center space-x-1.5 px-4 py-2.5 bg-muted hover:bg-muted text-foreground rounded-lg border border-border/50 text-xs font-medium transition-all border border-border ">
 ...
 @method('DELETE')
 <button type="submit"
 class="w-full flex items-center px-3 py-2 text-xs font-bold text-red-655 hover:bg-muted rounded-lg transition-colors text-left">
