...
@section('content')
 ...
 :class="tab === 'trash' ? 'bg-card border border-border text-foreground font-bold' : 'text-muted-foreground hover:text-foreground border-transparent'"
 class="flex-1 py-2 rounded-lg text-xs uppercase tracking-wider transition-all focus:outline-none flex items-center justify-center space-x-2">
 <i data-lucide="trash-2" class="w-4 h-4 text-muted-foreground"></i>
 <span class="text-destructive">Trash Bin</span>
 <span class="text-[10px] bg-muted text-foreground px-2 py-0.5 rounded-full font-bold">
 ...
 <div class="bg-card border border-border rounded-xl p-3.5 flex items-center justify-between hover:border-foreground transition-all page-item cursor-move group"
 ...
 @method('DELETE')
 <button type="submit"
 class="w-full flex items-center space-x-2 px-3.5 py-2 text-xs text-destructive hover:bg-muted font-bold transition-all text-left focus:outline-none">
 ...
 <div class="bg-card border border-border rounded-xl p-3 flex items-center justify-between hover:border-foreground transition-all page-item cursor-move group"
 data-page-id="{{ $page->id }}">
 ...
 <i data-lucide="check-circle" class="w-6 h-6 mb-1 text-muted-foreground"></i>
 ...
 class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-semibold bg-muted text-foreground border border-blue-100"
 ...
 <span
 :class="page.is_active ? 'bg-muted text-foreground border border-emerald-250' : 'bg-muted text-muted-foreground border border-border'"
 ...
 <button type="submit"
 class="w-full flex items-center space-x-2 px-4 py-2 text-xs text-muted-foreground hover:bg-muted font-semibold transition-all text-left focus:outline-none">
 ...
 <button type="submit"
 class="w-full py-2 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-lg text-xs border border-black/10 transition-all">
 ...
 <div
 class="p-4 bg-muted border border-border text-foreground rounded-xl flex items-start space-x-3 text-xs font-medium">
 <i data-lucide="alert-triangle" class="w-4.5 h-4.5 mt-0.5 flex-shrink-0 text-destructive"></i>
 <div>
 ...
 <div
 class="p-3 bg-muted/20 border border-border rounded-xl flex items-center justify-between hover:bg-muted/40 transition-colors">
 <div class="truncate">
 <span
 ...
 @csrf
 <button type="submit"
 class="px-2.5 py-1.5 bg-muted text-foreground hover:bg-muted rounded-lg text-[10px] font-medium border border-border transition-colors flex items-center space-x-1">
 ...
 @method('DELETE')
 <button type="submit"
 class="px-2.5 py-1.5 bg-muted text-destructive hover:bg-muted rounded-lg text-[10px] font-bold border border-border transition-colors flex items-center space-x-1">
 ...
 <button type="submit"
 class="px-6 py-2.5 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-lg text-xs border border-black/10 transition-all">
 Create Page
 </button>
 </div>
 </form>
