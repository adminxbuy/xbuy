...
@section('header_actions')
 ...
 class="px-3.5 py-2 bg-muted hover:bg-muted text-foreground font-semibold rounded-xl text-xs transition-all flex items-center space-x-1.5 border border-border">
 ...
 class="px-4.5 py-2 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-lg text-xs border border-black/10 transition-all flex items-center justify-center">
 Save Changes
 </button>
 </div>
@endsection
