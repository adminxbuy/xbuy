...
<div class="w-full space-y-6" x-data="createStaffPage()">
 ...
 {{-- Form Column --}}
 <form action="{{ route('admin.accounts.store') }}" method="POST" class="bg-card border border-border rounded-xl p-6 space-y-6">
 @csrf
 ...
 <div x-show="userExists" x-cloak class="mt-2 p-3 bg-muted text-foreground border border-border rounded-xl text-xs flex items-start gap-2 ">
 <i data-lucide="check-circle-2" class="w-4 h-4 text-muted-foreground shrink-0 mt-0.5"></i>
 ...
 <span class="text-[9px] font-semibold px-2 py-0.5 bg-muted text-foreground rounded border border-blue-100" x-text="sections[mod]"></span>
 </template>
 </div>
 </div>
