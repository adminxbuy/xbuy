                        ...
                        <td class="px-6 py-4">
                            <div class="flex flex-col gap-1.5">
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border w-max
                                    @if($dispute->urgency_status === 'critical') bg-rose-50 text-rose-705 border-rose-200/60
                                    @elseif($dispute->urgency_status === 'high') bg-amber-50 text-amber-705 border-amber-200/60
                                    @else bg-emerald-50 text-emerald-705 border-emerald-200/60 @endif">
