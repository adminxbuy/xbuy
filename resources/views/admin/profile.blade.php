...
<div class="space-y-6">
 ...
 <input type="text" id="requested_name" name="requested_name" value="{{ old('requested_name', $user->name) }}"  class="w-full px-3.5 py-2 border border-border rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring transition-all">
 <span class="text-[10px] text-muted-foreground font-semibold block flex items-center space-x-1">
 ...
 <input type="email" id="requested_email" name="requested_email" value="{{ old('requested_email', $user->email) }}"  class="w-full px-3.5 py-2 border border-border rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring transition-all">
 <span class="text-[10px] text-muted-foreground font-semibold block flex items-center space-x-1">
 <i data-lucide="shield-alert" class="w-3 h-3 flex-shrink-0"></i>
 ...
 <input type="text" id="requested_mobile" name="requested_mobile" value="{{ old('requested_mobile', $user->phone) }}"  class="w-full px-3.5 py-2 border border-border rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring transition-all">
 <span class="text-[10px] text-muted-foreground font-semibold block flex items-center space-x-1">
 <i data-lucide="shield-alert" class="w-3 h-3 flex-shrink-0"></i>
 ...
 <select id="gender" name="gender"  class="w-full px-3.5 py-2 border border-border rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring transition-all cursor-pointer">
 ...
 <input type="text" id="dob" name="dob" value="{{ old('dob', $user->dob ? \Illuminate\Support\Carbon::parse($user->dob)->format('Y-m-d') : '') }}"  class="flatpickr-date w-full px-3.5 py-2 border border-border rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring transition-all cursor-pointer">
 <span class="text-[10px] text-muted-foreground block">Updates directly.</span>
 </div>
 </div>
 </div>
 ...
 <textarea id="requested_bank_account" name="requested_bank_account" rows="4"  placeholder="e.g. State Bank of India&#10;Holder: Toby Belhome&#10;Account No: 12345678901&#10;IFSC: SBIN0001234"
 ...
 <input type="text" id="requested_upi_id" name="requested_upi_id" value="{{ old('requested_upi_id', $profile->upi_id) }}"  placeholder="e.g. toby@ybl"
 ...
 @if($req->status === 'open')
 <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold bg-muted text-foreground border border-border">
 Pending Approval
 </span>
