...
<div class="bg-card border border-border rounded-xl ring-0 overflow-hidden mb-6">
 ...
 <input type="text" name="search" value="{{ request('search') }}" placeholder="Search staff..."  class="pl-9 pr-4 py-2 text-xs border border-border rounded-lg bg-muted hover:bg-muted focus:bg-card focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none transition-all w-56 font-semibold">
 </div>
