            ...
            <div class="bg-card border border-border rounded-xl p-6 shadow-sm">
                ...
                <div class="pt-8 px-2 max-w-xl">
                    <div class="relative pl-8 space-y-8 border-l border-border">
                        ...
                        <div class="relative">
                            <span
                                class="absolute -left-[41px] top-0.5 w-6 h-6 bg-emerald-500 rounded-full border-4 border-card flex items-center justify-center text-white shadow-sm">
                        ...
                        @elseif($order->order_status === 'disputed')
                            <div class="relative">
                                <span
                                    class="absolute -left-[41px] top-0.5 w-6 h-6 bg-rose-600 rounded-full border-4 border-card flex items-center justify-center text-white shadow-sm animate-pulse">
                                ...
                                <a href="{{ route('admin.disputes.show', $order->dispute->id) }}"
                                    class="inline-flex items-center space-x-1 text-xs font-bold bg-rose-100 hover:bg-primary text-primary-foreground hover:bg-primary/90 text-rose-800 hover:text-foreground px-2.5 py-1 rounded shadow-sm transition-all mt-2">
            ...
            <div class="bg-card border border-border rounded-xl p-6 shadow-sm">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1 flex justify-between items-center gap-4">
                        ...
                        <a href="{{ route('admin.listings.show', $order->listing_id) }}" target="_blank"
                            class="inline-flex items-center gap-1.5 bg-muted hover:bg-muted text-foreground hover:text-yellow-805 font-bold px-3 py-2 rounded-xl text-xs border border-border/50 shadow-sm transition-all shrink-0">
            ...
            <div class="bg-card border border-border rounded-xl p-6 shadow-sm">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="bg-muted p-4 border border-border rounded-xl space-y-2 mt-4 text-xs">
                        ...
                        <div
                            class="flex justify-between items-center text-emerald-700 font-semibold border-t border-border/60 pt-2">
