...
@section('content')
 ...
 @if($seller->status === 'active') bg-muted text-foreground border border-border/60
 @elseif($seller->status === 'suspended') bg-muted text-foreground
 @elseif($seller->status === 'banned') bg-muted text-foreground border border-border/60
 ...
 @endphp
 <div class="bg-card border border-border rounded-xl p-6 " x-data="{
 activeDoc: null,
 showBankAcc: false,
 showIfsc: false,
 showUpi: false,
 ...
 @if($seller->kyc_status === 'pending') bg-muted text-foreground border border-border/60
 @elseif($seller->kyc_status === 'approved') bg-muted text-foreground border border-border/60
 @else bg-muted text-foreground border border-border/60 @endif">
 ...
 <button type="submit"
 class="flex-1 bg-rose-600 hover:bg-rose-700 text-white text-xs font-medium py-2 px-3 rounded-lg transition-all">
 Submit Rejection
 </button>
 </div>
 </form>
 ...
 <button type="submit"
 class="bg-primary text-primary-foreground hover:bg-primary/90 font-medium px-3 py-2 rounded-lg text-xs transition-all">
 Apply
 </button>
 </form>
 </div>
 ...
 <span
 class="px-3 py-1.5 text-xs rounded-full font-semibold inline-block bg-muted text-foreground border border-border/60">
 ...
 @else
 <span class="px-3 py-1.5 text-xs rounded-full font-semibold inline-block bg-muted text-foreground border border-border/60">
