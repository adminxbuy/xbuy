...
<div class="rounded-xl overflow-hidden border border-border bg-card" x-data="{ selectedIds: [], selectAll: false, bulkAction: '' }">
 ...
 @if($seller->kyc_status === 'pending') bg-muted text-foreground border-border/60
 @elseif($seller->kyc_status === 'approved') bg-muted text-foreground border-border/60
 ...
 <td class="px-6 py-3.5">
 <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border
 @if($seller->status === 'active') bg-muted text-foreground border-border/60
 @elseif($seller->status === 'suspended') bg-muted text-foreground border-border/60
 @elseif($seller->status === 'banned') bg-muted text-foreground border-border/60
