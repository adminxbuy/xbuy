                ...
                <div class="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" rows="3" placeholder="Brief search snippet description..."
                                  class="w-full px-3 py-2 border border-border rounded-lg text-xs focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring resize-none">{{ $article->seo_description }}</textarea>
                    </div>
                </div>
