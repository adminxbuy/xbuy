...
<div class="p-6 max-w-6xl mx-auto" x-data="{ 
    ...
    <div class="flex items-center space-x-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-foreground tracking-tight">Write New Article</h1>
            <p class="text-muted-foreground text-sm">Create high-quality content, optimize SEO, and publish alerts.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                <!-- Cover Image Block -->
                <div class="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm" x-data="{ imageType: 'file' }">
                ...
                <div class="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" rows="3" placeholder="Brief search snippet description..."
                                  class="w-full px-3 py-2 border border-border rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring resize-none"></textarea>
                    </div>
                </div>
