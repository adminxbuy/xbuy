                ...
                <div class="bg-card border border-border rounded-xl p-6 space-y-4 shadow-sm">
                    ...
                    <div>
                        ...
                        <input type="text" name="published_at" 
                               class="flatpickr-datetime w-full px-3 py-2 border border-border rounded-lg text-xs focus:outline-none focus:ring-1 focus:ring-ring focus:border-ring" placeholder="Select date & time">
                    </div>
