...
<div class="p-6 max-w-6xl mx-auto" x-data="{ 
    ...
    <div class="flex items-center space-x-3 mb-6">
        ...
        <div>
            <h1 class="text-2xl font-bold text-zinc-900 tracking-tight">Write New Article</h1>
            <p class="text-zinc-500 text-sm">Create high-quality content, optimize SEO, and publish alerts.</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.articles.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-6">
                <!-- Cover Image Block -->
                <div class="bg-white border border-zinc-200 rounded-xl p-6 space-y-4 shadow-sm" x-data="{ imageType: 'file' }">
                    ...
                    <div x-show="imageType === 'file'">
                        ...
                        <p class="text-[10px] text-zinc-400 mt-1">Recommended size: 800x450px (WebP/JPEG/PNG)</p>
                    </div>
                ...
                <div class="bg-white border border-zinc-200 rounded-xl p-6 space-y-4 shadow-sm">
                    <h3 class="text-sm font-bold text-zinc-950 uppercase tracking-wider pb-2 border-b border-zinc-100">SEO Settings (Optional)</h3>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea name="seo_description" rows="3" placeholder="Brief search snippet description..."
                                  class="w-full px-3 py-2 border border-zinc-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-zinc-950 focus:border-zinc-950 resize-none"></textarea>
                    </div>
                </div>
                ...
                <div class="bg-white border border-zinc-200 rounded-xl p-6 space-y-4 shadow-sm">
                    ...
                    <div class="flex items-center justify-between" x-data="{ isPublished: false }">
                        <span class="text-xs font-semibold text-zinc-700">Publish Instantly</span>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-1.5">Scheduled Date & Time (Optional)</label>
