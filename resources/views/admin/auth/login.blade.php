...
<body class="min-h-svh flex items-center justify-center bg-muted/40 p-6">
 ...
 @if($errors->any())
 <div class="mb-6 p-3 rounded-lg border border-border bg-muted text-foreground text-sm font-medium/50/50">
 {{ $errors->first() }}
 </div>
 @endif
 ...
 class="flex h-9 w-full rounded-lg border border-input bg-transparent px-3 py-1 text-sm transition-[color,box-shadow] outline-none placeholder:text-muted-foreground focus:border-ring focus:ring-2 focus:ring-ring/50">
 </div>
 ...
 <button type="submit"
 class="inline-flex w-full items-center justify-center h-10 rounded-lg bg-primary text-primary-foreground text-sm font-semibold transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
 Log in
 </button>
 </form>
 </div>
