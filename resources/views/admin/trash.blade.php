...
<div class="space-y-6">
 <!-- Alert Notifications -->
 @if(session('success'))
 <div class="p-4 bg-card border border-border text-foreground rounded-xl text-xs font-semibold flex items-center space-x-2">
 <i data-lucide="check-circle" class="w-4.5 h-4.5 text-foreground"></i>
 <span>{{ session('success') }}</span>
 </div>
 @endif
 @if(session('error'))
 <div class="p-4 bg-card border border-border text-foreground rounded-xl text-xs font-semibold flex items-center space-x-2">
 <i data-lucide="alert-octagon" class="w-4.5 h-4.5 text-foreground"></i>
 <span>{{ session('error') }}</span>
 </div>
 @endif

 <!-- Search Bar -->
 <div class="bg-card border border-border rounded-xl p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
 ...
 @elseif($modelName === 'alerts')
 <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-muted text-foreground border border-border">Severity: {{ $item->severity }}</span>
 @elseif($modelName === 'pages')
