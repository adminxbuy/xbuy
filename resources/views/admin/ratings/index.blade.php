...
@section('content')
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-5">
            <!-- Average Star Rating -->
            <div class="bg-card border border-border rounded-xl p-5 shadow-sm flex items-center justify-between">
                <div>
            ...
            <div class="col-span-1 md:col-span-2 bg-card border border-border rounded-xl p-5 shadow-sm">
        ...
        <div x-data="{ openTrash: false }"
            class="bg-muted border border-border rounded-xl p-4 transition-all shadow-sm">
