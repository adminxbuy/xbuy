...
<div class="space-y-6 overflow-y-auto">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <form action="{{ route('admin.sales-overview') }}" method="GET" class="flex flex-wrap items-center gap-3">
            ...
            <button type="submit" name="export" value="csv" class="inline-flex items-center justify-center gap-1.5 h-9 px-3.5 border border-border hover:bg-muted rounded-lg text-xs font-semibold transition-all shadow-sm">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="rounded-xl border border-border bg-card p-6 flex flex-col justify-between shadow-sm relative overflow-hidden">
        ...
        <div class="space-y-4">
            ...
            <div class="rounded-xl border border-border bg-muted p-4 shadow-sm flex items-start gap-3">
                <div class="w-8 h-8 rounded-lg bg-card border border-border flex items-center justify-center text-emerald-600 shrink-0">
                ...
                <a href="{{ route('admin.settings') }}" class="text-[10px] font-bold text-foreground border border-border bg-card hover:bg-muted px-2 py-1 rounded shadow-sm shrink-0">
                    Configure
                </a>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="rounded-xl border border-border bg-card p-6 shadow-sm flex flex-col justify-between min-h-[250px] relative overflow-hidden">
        ...
        <div class="rounded-xl border border-border bg-card p-6 shadow-sm flex flex-col justify-between" x-data="{
            amount: 5000,
            rate: 5,
