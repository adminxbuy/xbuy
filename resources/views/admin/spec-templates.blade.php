...
@section('content')
 ...
 :class="activeCategory === {{ $cat->id }} ? 'bg-primary text-primary-foreground hover:bg-primary/90 text-primary-foreground font-semibold border-black/10' : 'bg-card text-muted-foreground hover:bg-muted border-border'"
 ...
 'bg-muted text-foreground border border-blue-100': spec.spec_type === 'text',
 'bg-muted text-foreground border border-amber-100': spec.spec_type === 'number',
 'bg-muted text-foreground border border-purple-100': spec.spec_type === 'select',
 'bg-muted text-foreground border border-emerald-100': spec.spec_type === 'boolean'
 ...
 <span
 class="text-xs font-bold text-destructive bg-muted border border-border px-2 py-0.5 rounded-full">Yes</span>
 </template>
 <template x-if="!spec.is_required">
 ...
 <span
 class="text-xs font-bold text-foreground bg-muted border border-amber-100 px-2 py-0.5 rounded-full">Yes</span>
 </template>
 <template x-if="!spec.is_highlighted">
 <span class="text-xs text-muted-foreground px-2 py-0.5">No</span>
 </template>
 ...
 <button type="submit"
 class="px-6 py-2.5 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-lg text-xs border border-black/10 transition-all hover:scale-[1.02]">
 Save Field
 </button>
 </div>
 </form>
