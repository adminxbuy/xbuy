...
<div class="space-y-6">
    ...
    <div class="p-4 rounded-lg text-xs font-medium flex items-center justify-between border border-amber-200 bg-amber-50 text-amber-800 dark:border-amber-900 dark:bg-amber-950/60 dark:text-amber-200">
                    ...
                    <div class="space-y-1.5">
                        <div class="flex items-center justify-between text-xs">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="px-2 py-0.5 rounded-full text-[10px] font-medium {{ $isUp ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300' : 'bg-rose-50 text-rose-700 dark:bg-rose-950/60 dark:text-rose-300' }}">{{ $trendVal }}</span>
                            </div>
                        ...
                        <td class="px-6 py-3.5">
                            @php
                                $disputeBadge = match($dispute->status) {
                                    ...
                                    'seller_responded' => 'bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950/60 dark:text-blue-300 dark:border-blue-900',
                        ...
                        <td class="px-6 py-3.5">
                            @php
                                $orderBadge = match($order->status) {
                                    ...
                                    'in_transit' => 'bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-950/60 dark:text-blue-300 dark:border-blue-900',
                                    default => 'bg-muted text-muted-foreground border-border',
                                };
                            @endphp
