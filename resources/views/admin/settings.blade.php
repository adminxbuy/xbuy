...
@section('content')
<div class="bg-card border border-border rounded-xl ring-0 overflow-hidden p-6" x-data="{  tab: 'general',  testEmail: '',  testSuccess: '',  testError: '',  testing: false,  libraryOpen: false,
 libraryImages: [],
 libraryTarget: '',
 ...
 <!-- Tabs Header -->
 <div class="flex border-b border-border mb-6 overflow-x-auto pb-1 gap-1">
 @foreach([
 ...
 <span class="ml-3 text-xs font-semibold text-foreground">Enabled</span>
 </label>
 ';
 }
  $inputClass = "w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card";
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="settings" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <!-- Logo Upload -->
 <div class="space-y-1.5">
 <label class="block text-xs font-bold text-muted-foreground uppercase tracking-wider">Website Logo</label>
 <input type="hidden" name="selected_logo_path" id="selected_logo_path" value="">
 <div class="flex items-center space-x-4">
 <div class="w-14 h-14 rounded-xl border border-border flex items-center justify-center bg-muted overflow-hidden flex-shrink-0">
 <template x-if="currentLogo">
 <img :src="currentLogo" class="object-contain max-w-full max-h-full p-1">
 </template>
 <template x-if="!currentLogo">
 <div class="text-muted-foreground text-[10px] uppercase font-bold">No Logo</div>
 </template>
 </div>
 ...
 <p class="text-[10px] text-muted-foreground">Recommended: 250x80px PNG or SVG.</p>
 </div>
 </div>
 </div>
 ...
 <!-- Favicon Upload -->
 <div class="space-y-1.5">
 <label class="block text-xs font-bold text-muted-foreground uppercase tracking-wider">Website Favicon</label>
 ...
 <template x-if="!currentFavicon">
 <div class="text-muted-foreground text-[10px] uppercase font-bold">No Icon</div>
 </template>
 </div>
 <div class="flex-1 space-y-2">
 <div class="flex flex-wrap gap-2">
 ...
 <p class="text-[10px] text-muted-foreground">Recommended: 32x32px ICO or PNG.</p>
 </div>
 </div>
 </div>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="package" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="shopping-cart" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="users" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="user" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="alert-triangle" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="bell" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="globe" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="share-2" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 Social Media Links
 </h3>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
 ...
 <h3 class="text-base font-semibold text-foreground pb-2 mb-4 flex items-center">
 <i data-lucide="smartphone" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 Get the App
 </h3>
 <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
 ...
 <div class="bg-muted border border-border rounded-xl p-4 text-xs text-muted-foreground space-y-1.5 w-full">
 ...
 <li>Copy the link: <span class="font-mono bg-muted px-1 rounded">play.google.com/store/apps/details?id=...</span></li>
 ...
 <div class="mt-2 pt-6 border-t border-border">
 <h3 class="text-base font-semibold text-foreground pb-2 mb-4 flex items-center">
 <i data-lucide="shield-check" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 Social Sign-in Configuration
 </h3>
  <!-- Google Sign-in -->
 <div class="p-4 bg-muted border border-border rounded-xl mb-6 space-y-4">
 <div class="flex items-center justify-between border-b border-border/60 pb-2">
 <span class="font-bold text-xs uppercase tracking-wider text-foreground flex items-center gap-1.5">
 ...
 @if($setting = $settings->firstWhere('key', $key))
 <div class="space-y-1.5">
 <label class="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider">{{ str_replace('google_', '', str_replace('_', ' ', $setting->key)) }}</label>
 @if(str_contains($key, 'secret'))
 <input type="password" name="{{ $setting->key }}" value="{{ $setting->value }}" class="w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card">
 @else
 {!! $renderInput($setting) !!}
 @endif
 </div>
 ...
 <p class="text-[10px] text-muted-foreground font-mono">Callback URL: <span class="bg-muted px-1.5 py-0.5 rounded text-foreground select-all">{{ url('/auth/social/google/callback') }}</span></p>
 </div>
 </div>
 </div>
 ...
 @if($setting = $settings->firstWhere('key', $key))
 <div class="space-y-1.5">
 <label class="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider">{{ str_replace('facebook_', '', str_replace('_', ' ', $setting->key)) }}</label>
 @if(str_contains($key, 'secret'))
 <input type="password" name="{{ $setting->key }}" value="{{ $setting->value }}" class="w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card">
 @else
 {!! $renderInput($setting) !!}
 ...
 @endforeach
 <div class="col-span-2">
 <p class="text-[10px] text-muted-foreground font-mono">Callback URL: <span class="bg-muted px-1.5 py-0.5 rounded text-foreground select-all">{{ url('/auth/social/facebook/callback') }}</span></p>
 </div>
 </div>
 </div>
 ...
 <div class="flex items-center justify-between border-b border-border/60 pb-2">
 <span class="font-bold text-xs uppercase tracking-wider text-foreground flex items-center gap-1.5">
 <i data-lucide="aperture" class="w-4 h-4 text-foreground"></i> Apple OAuth Settings
 </span>
 ...
 @if($setting = $settings->firstWhere('key', $key))
 <div class="space-y-1.5">
 <label class="block text-[10px] font-bold text-muted-foreground uppercase tracking-wider">{{ str_replace('apple_', '', str_replace('_', ' ', $setting->key)) }}</label>
 @if(str_contains($key, 'secret'))
 <input type="password" name="{{ $setting->key }}" value="{{ $setting->value }}" class="w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card">
 @else
 {!! $renderInput($setting) !!}
 ...
 @endforeach
 <div class="col-span-2">
 <p class="text-[10px] text-muted-foreground font-mono">Callback URL: <span class="bg-muted px-1.5 py-0.5 rounded text-foreground select-all">{{ url('/auth/social/apple/callback') }}</span></p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div class="mt-2 pt-6 border-t border-border">
 <h3 class="text-base font-semibold text-foreground pb-2 mb-4 flex items-center">
 <i data-lucide="file-text" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="credit-card" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="truck" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <input type="password" name="shiprocket_password" value="{{ $setting->value }}" class="w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card">
 @else
 {!! $renderInput($setting) !!}
 @endif
 <p class="text-[10px] text-muted-foreground leading-relaxed">{{ $setting->description }}</p>
 ...
 @method('PUT')
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="mail" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 SMTP Server Config
 </h3>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
 @forelse($settings->where('group', 'smtp') as $setting)
 <div class="space-y-1.5">
 <label for="{{ $setting->key }}" class="block text-xs font-bold text-muted-foreground uppercase tracking-wider">
 {{ ucwords(str_replace('smtp ', '', str_replace('_', ' ', $setting->key))) }}
 </label>
  @if($setting->key === 'smtp_encryption')
 <select id="{{ $setting->key }}" name="{{ $setting->key }}"  class="w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card">
 ...
 class="w-full p-3 border border-border rounded-xl text-sm focus:ring-1 focus:ring-ring focus:border-ring focus:outline-none bg-card">
 @else
 ...
 @empty
 <p class="text-muted-foreground col-span-2 py-8 text-center">SMTP parameters are missing. Please re-seed.</p>
 @endforelse
 </div>
  <div class="pt-5 border-t border-border flex justify-end">
 <button type="submit" class="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold py-2.5 px-5 rounded-lg ring-0 border border-black/10 transition-all text-xs">
 ...
 <div class="p-5 bg-muted border border-border rounded-xl space-y-4">
 <h4 class="font-bold text-foreground text-xs uppercase tracking-wider flex items-center">
 <i data-lucide="send" class="w-4 h-4 mr-2 text-muted-foreground"></i>
 ...
 class="bg-primary text-primary-foreground hover:bg-primary/90 font-semibold px-5 py-2.5 rounded-lg text-xs transition-all disabled:opacity-50 flex items-center justify-center space-x-2">
 ...
 <div x-show="testSuccess" x-cloak class="p-3 bg-muted border border-border text-foreground rounded-xl text-xs font-semibold" x-text="testSuccess"></div>
 <div x-show="testError" x-cloak class="p-3 bg-muted border border-border text-foreground rounded-xl text-xs font-semibold" x-text="testError"></div>
 </div>
 </div>
 ...
 <h3 class="text-base font-semibold text-foreground border-b border-border pb-2 flex items-center">
 <i data-lucide="life-buoy" class="w-4.5 h-4.5 mr-2 text-muted-foreground"></i>
 ...
 <div class="bg-card rounded-xl max-w-2xl w-full max-h-[85vh] flex flex-col shadow-2xl border border-border" @click.away="libraryOpen = false">
 <!-- Modal Header -->
 ...
 <i data-lucide="image-off" class="w-10 h-10 mx-auto mb-3 text-muted-foreground"></i>
 <p class="text-xs font-semibold">No assets found in library</p>
 <p class="text-[10px] text-muted-foreground mt-1">Upload images to public/website_assets/images directory</p>
 </div>
 </template>
 <template x-if="libraryImages.length > 0">
 <div class="grid grid-cols-3 sm:grid-cols-4 gap-4">
 <template x-for="img in libraryImages" :key="img.url">
 <button type="button" @click="selectLibraryImage(img.url)"  class="group p-2 bg-card rounded-xl border border-border hover:border-foreground hover:ring-2 hover:ring-foreground/20 transition-all text-left flex flex-col items-center justify-between aspect-square">
 ...
 <p class="text-[9px] font-semibold text-foreground truncate" x-text="img.name"></p>
 ...
 <button type="button" @click="libraryOpen = false" class="px-4 py-2 border border-border bg-card hover:bg-muted text-foreground rounded-lg text-xs font-semibold transition-all">
 Cancel
 </button>
 </div>
 </div>
