...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
 <!-- Card 1: This Month -->
 <div class="bg-card border border-border rounded-xl p-5 flex flex-col justify-between relative overflow-hidden">
...
<div class="bg-card border border-border rounded-xl ring-0 overflow-hidden mb-6">
 ...
 <td class="px-6 py-4 text-foreground font-bold text-xs bg-emerald-500/5">
