...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div class="lg:col-span-2 space-y-8 bg-white border border-zinc-200 rounded-3xl p-6 md:p-10 shadow-sm">
                <!-- Article Headers -->
                <div class="space-y-4">
                ...
                @if($article->cover_image)
                    <div class="w-full aspect-[16/9] bg-zinc-100 rounded-2xl overflow-hidden border border-zinc-150 shadow-sm">
