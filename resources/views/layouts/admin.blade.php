    ...
    <div class="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        <header class="h-14 border-b flex items-center justify-between px-4 lg:px-6 flex-shrink-0" style="border-color: var(--border); background: var(--background);">
            <div class="flex items-center gap-1 lg:gap-2">
                <button class="p-1.5 rounded-lg transition-colors -ml-1" style="color: var(--muted-foreground);" 
                    ...
                    <div x-show="open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="transform opacity-0 scale-95" x-transition:enter-end="transform opacity-100 scale-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="transform opacity-100 scale-100" x-transition:leave-end="transform opacity-0 scale-95" class="absolute right-0 mt-2 w-72 rounded-xl shadow-lg p-4 z-50 text-left space-y-3.5" style="background: var(--card); border: 1px solid var(--border);" x-cloak>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-5 gap-1 p-0.5 rounded-lg" style="background: var(--muted); border: 1px solid var(--border);">
                                ...
                                <button @click="themePreset = 'emerald'; localStorage.setItem('themePreset', 'emerald')" class="py-1 text-xs font-semibold rounded transition-all" :class="themePreset === 'emerald' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : 'hover:text-zinc-800'" style="color: var(--muted-foreground);">
                                    <span class="w-4 h-4 rounded-full inline-block" style="background: #10b981;"></span>
                                </button>
                                <button @click="themePreset = 'blue'; localStorage.setItem('themePreset', 'blue')" class="py-1 text-xs font-semibold rounded transition-all" :class="themePreset === 'blue' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : 'hover:text-zinc-800'" style="color: var(--muted-foreground);">
                                    <span class="w-4 h-4 rounded-full inline-block" style="background: #3b82f6;"></span>
                                </button>
                                <button @click="themePreset = 'rose'; localStorage.setItem('themePreset', 'rose')" class="py-1 text-xs font-semibold rounded transition-all" :class="themePreset === 'rose' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : 'hover:text-zinc-800'" style="color: var(--muted-foreground);">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-3 gap-1 p-0.5 rounded-lg" style="background: var(--muted); border: 1px solid var(--border);">
                                <button @click="themeScale = 'xs'; localStorage.setItem('themeScale', 'xs')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeScale === 'xs' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">XS</button>
                                <button @click="themeScale = 'default'; localStorage.setItem('themeScale', 'default')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeScale === 'default' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">MD</button>
                                <button @click="themeScale = 'lg'; localStorage.setItem('themeScale', 'lg')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeScale === 'lg' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">LG</button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-5 gap-1 p-0.5 rounded-lg" style="background: var(--muted); border: 1px solid var(--border);">
                                <button @click="themeRadius = 'none'; localStorage.setItem('themeRadius', 'none')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeRadius === 'none' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">0</button>
                                <button @click="themeRadius = 'sm'; localStorage.setItem('themeRadius', 'sm')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeRadius === 'sm' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">SM</button>
                                <button @click="themeRadius = 'md'; localStorage.setItem('themeRadius', 'md')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeRadius === 'md' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">MD</button>
                                <button @click="themeRadius = 'lg'; localStorage.setItem('themeRadius', 'lg')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeRadius === 'lg' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">LG</button>
                                <button @click="themeRadius = 'xl'; localStorage.setItem('themeRadius', 'xl')" class="py-1 text-xs font-semibold rounded transition-all" :class="themeRadius === 'xl' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">XL</button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-1 p-0.5 rounded-lg" style="background: var(--muted); border: 1px solid var(--border);">
                                <button @click="isDark = false; localStorage.setItem('darkMode', 'false')" class="py-1 text-xs font-semibold rounded transition-all" :class="!isDark ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">Light</button>
                                <button @click="isDark = true; localStorage.setItem('darkMode', 'true')" class="py-1 text-xs font-semibold rounded transition-all" :class="isDark ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">Dark</button>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 gap-1 p-0.5 rounded-lg" style="background: var(--muted); border: 1px solid var(--border);">
                                <button @click="layoutMode = 'full'; localStorage.setItem('layoutMode', 'full')" class="py-1 text-xs font-semibold rounded transition-all" :class="layoutMode === 'full' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">Full</button>
                                <button @click="layoutMode = 'centered'; localStorage.setItem('layoutMode', 'centered')" class="py-1 text-xs font-semibold rounded transition-all" :class="layoutMode === 'centered' ? 'bg-white shadow-sm text-zinc-900 border border-zinc-200' : ''" style="color: var(--muted-foreground);">Centered</button>
                            </div>
                        </div>
