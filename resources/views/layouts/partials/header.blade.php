...
<div x-data="{  mobileOpen: false,  categoriesOpen: false,  brandsOpen: false,  userMenuOpen: false,  activeParent: null,  searchFocused: false,
 closeCategoriesTimer: null }" class="relative z-50 bg-white border-zinc-200/80 sticky top-0">
