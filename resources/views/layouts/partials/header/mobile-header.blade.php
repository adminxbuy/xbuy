<div class="px-4 py-3 bg-[#fdd835]">
 ...
 <div class="relative flex items-center bg-white border border-black/10 rounded-xl overflow-hidden w-full focus-within:ring-2 focus-within:ring-black/10 focus-within:border-black/20 transition-all">
 ...
 <a href="/listings?search={{ urlencode($brand) }}"  class="px-3 py-1.5 bg-zinc-100 hover:bg-zinc-200 transition-all text-[10px] font-semibold text-zinc-700 hover:text-zinc-900 rounded-full">
 {{ $brand }}
 </a>
 @endforeach
 </div>
