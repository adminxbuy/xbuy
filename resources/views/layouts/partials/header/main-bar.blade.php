    ...
    <div class="flex items-center justify-between h-[72px] gap-6">
        ...
        <div class="flex items-center space-x-4">
            ...
            @auth
                ...
                <div class="relative" @click.away="userMenuOpen = false">
                    <button @click="userMenuOpen = !userMenuOpen" 
                            class="flex items-center space-x-1.5 text-zinc-700 hover:text-black font-medium text-sm transition-all focus:outline-none cursor-pointer">
            ...
            <a href="/dashboard/listings/create" 
               class="bg-black text-white font-semibold px-6 py-1.5 rounded-[0.45rem] text-sm flex items-center justify-center">
                <span>Sell</span>
            </a>
        </div>
    </div>
